...
<template>
  <div>
    <footer class="text-center justify-center text-white bg-amber-50 dark:bg-gray-800">
        ...
        <div class="flex justify-center mb-9">
          ...
          <a href="https://github.com/matthewww-pl" class="text-gray-700 dark:text-gray-200">
            <svg
              ...
              data-prefix="fab"
              data-icon="github"
              class="svg-inline--fa fa-github w-7"
              role="img"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 496 512"
            >
      ...
      <div class="text-center text-gray-700 dark:text-gray-200 bg-amber-100 dark:bg-gray-900 p-4">
        © 2022 Copyright:
        <a href="mailto:blaszczak.mat@gmail.com">MatPro</a>
      </div>
    </footer>
  </div>
</template>